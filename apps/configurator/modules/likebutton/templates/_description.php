<div id="desc_left">
  ...
  <ul>
    <li id="facebook_logo" class="service_logo"></li>
    <li id="twitter_logo" class="service_logo"></li>
    <li class="important-text"><?php echo __('MORE_TO_COME', null, 'configurator'); ?></li>
  </ul>
</div>
