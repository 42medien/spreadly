...
<div id="like-submit">
		...
		<?php } ?>
		<a class="send B" href="#">Continue and Share</a>
		<?php if ($sf_user->isAuthenticated() ) { ?>
	  ...
	  <?php } else { ?>
	  <ul class="clearfix" id="like-oi-list">
	  	<li class="B" id="o1" onclick="window.open('<?php echo url_for("@signinto?service=twitter"); ?>', 'popup', 'width=580,height=450,scrollbars=no,toolbar=no,status=no,resizable=no,menubar=no,location=0,directories=no,top=150,left=150'); return false;">
	  	...
	  	<li class="B" id="o2" onclick="window.open('<?php echo url_for("@signinto?service=facebook"); ?>', 'popup', 'width=580,height=450,scrollbars=no,toolbar=no,status=no,resizable=no,menubar=no,location=0,directories=no,top=150,left=150'); return false;">
	  	...
	  	<li class="B" id="o3" onclick="window.open('<?php echo url_for("@signinto?service=linkedin"); ?>', 'popup', 'width=580,height=450,scrollbars=no,toolbar=no,status=no,resizable=no,menubar=no,location=0,directories=no,top=150,left=150'); return false;">
	  	...
	  	<li class="B" id="o4" onclick="window.open('<?php echo url_for("@signinto?service=google"); ?>', 'popup', 'width=580,height=450,scrollbars=no,toolbar=no,status=no,resizable=no,menubar=no,location=0,directories=no,top=150,left=150'); return false;">
