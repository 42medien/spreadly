          ...
          <?php } ?>
            <li class="B">
              ...
              <ul class="services">
                ...
                <li><a href="#" onclick="window.open('<?php echo url_for("@signinto?service=flattr"); ?>', 'auth_popup', 'width=700,height=800,scrollbars=no,toolbar=no,status=no,resizable=no,menubar=no,location=0,directories=no,top=150,left=150'); return false;"><?php echo __("another flattr-account"); ?></a></li>
              </ul>
            </li>
        </ul>
        <?php } else { ?>
        <ul class="clearfix" id="like-oi-list">
          ...
          <li class="B" id="o3" onclick="WidgetLikeForm.beforeSend();window.open('<?php echo url_for("@signinto?service=flattr"); ?>', 'auth_popup', 'width=700,height=800,scrollbars=no,toolbar=no,status=no,resizable=no,menubar=no,location=0,directories=no,top=150,left=150'); return false;">
