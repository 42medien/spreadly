...
<div class="footer_line">
  <div class="footer_shadow"></div>
    <span class="left">
      ...
      <span title="<?php echo $sf_user->getUser()->getUsername(); ?>" id="nav-username"><?php echo __('Hi'); ?> <a id="edit-settings-link" href="<?php echo url_for('@widget_settings'); ?>"><?php echo truncate_text($sf_user->getUser()->getUsername(), 10); ?></a></span> |
