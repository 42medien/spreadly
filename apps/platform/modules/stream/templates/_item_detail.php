...
<?php if (isset($pObject) && $pObject != null) {?>
  <div class="bg_light bd_normal_light">
		...
		<div id="preview">
		  <div id="yiid-widget">
		    <iframe src="http://widgets.<?php echo sfConfig::get("app_settings_host"); ?>/w/like/full.php?<?php echo 'url='.urlencode($pObject->getUrl()).'&cult='.$sf_user->getCulture().'&title='.urlencode($pObject->getTitle()).'&type=like&color=%23000000&short='; ?>" style="overflow:hidden; width:345px; height: 23px; padding: 3px 0;" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" allowTransparency="true"></iframe>
		  </div>
		</div>
...
<?php } else { ?>
  <div class="bg_light bd_normal_light">
    <div id="so_right_view" class="clearfix empty_right_view">
      ...
      <div id="preview">
        <div id="yiid-widget">
          <iframe src="http://widgets.<?php echo sfConfig::get("app_settings_host"); ?>/w/like/like.php?<?php echo 'url='.urlencode('http://www.yiid.com').'&cult='.$sf_user->getCulture().'&type=like&color=%23000000&short='; ?>" style="overflow:hidden; width:240px; height: 23px; padding: 3px 0;" frameborder="0" scrolling="no" marginheight="0" marginwidth="0" allowTransparency="true"></iframe>
        </div>
      </div>
