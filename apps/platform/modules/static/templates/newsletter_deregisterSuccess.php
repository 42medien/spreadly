...
<h1><?php echo __('HEADLINE_NEWSLETTER_DEREGISTER')?></h1>
<p class="newsletter-register-description"><?php echo __('DESCRIPTION_NEWSLETTER_DEREGISTER')?></p>
...
<table border="0" cellpadding="2" cellspacing="0">
    ...
    <tr>
        <td>&nbsp;</td>
        <td><input type="button" value="Newsletter abmelden" onclick="checkFieldsOut()" class="button green small" /></td>
    </tr>
...
<input type="hidden" name="Liste[2]" value="MTEwNzA%3D" />
</form>
