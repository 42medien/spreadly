...
function checkFieldsIn ()
{
	...
	<h1><?php echo __('HEADLINE_PRESS_REGISTER')?></h1>
	   <p class="newsletter-register-description"><?php echo __('DESCRIPTION_PRESS_REGISTER')?></p>
	      <form name="subscribe" class="newsletter-form" id="subscribe" action="http://redirect2.mailingwork.de/addabo.php" method="post" enctype="multipart/form-data" target="_blank">
	             <table border="0" cellpadding="2" cellspacing="0">
	                ...
	                <tr>
	                    <td>&nbsp;</td>
	                    <td><input type="button" value="anmelden" onclick="checkFieldsIn()" class="button green small" /></td>
	                </tr>
	            </table>
