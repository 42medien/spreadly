<div id="signin_area" class="single_box_with_shadow">
  <div id="signin_via_services">
      ...
      <div class="left_block left">
        <h5><?php echo __('Services you\'ve enabled:'); ?></h5>
	      <ul class="services_enabled normal_list">
            ...
            <?php echo __('your %1 %2 account', array('%1' => $lOi->getCommunity()->getName(), '%2' => link_to($lOi->getName(), $lOi->getUrl(), array('target' => '_blank'))), 'platform'); ?>
          </li>
          <?php } ?>
	      </ul>
	    </div>
        ...
        <h5><?php echo __('Add more services:'); ?></h5>
	      <ul class="services_disabled normal_list">
            ...
            <?php echo __('Add your %1 account', array('%1' => link_to('Twitter', '@auth_signin?service=twitter')), 'platform'); ?>
          </li>
	        <li>
            <span class="icon_big_facebook_add_service icon_big_add_service left">&nbsp;</span>
            <?php echo __('Add your %1 account', array('%1' => link_to('Facebook', '@auth_signin?service=facebook')), 'platform'); ?>
          </li>
	      </ul>
	    </div>
    </div>
    ...
    <div class="center_area clearfix">
      <?php echo link_to(__('Skip', null, 'platform'), '@stream'); ?>
    </div>
  </div>
</div>