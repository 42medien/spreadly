<div class="btn-group pull-right">
  <a href="<?php echo url_for("shares/global")."?".$od_query; ?>"  class="btn<?php if ($order_by_date) { echo " btn-inverse"; }; ?>">
    <?php echo __("Date"); ?>
  ...
  <a href="<?php echo url_for("shares/global")."?".$oc_query; ?>" class="btn<?php if ($order_by_clickback) { echo " btn-inverse"; }; ?>">
