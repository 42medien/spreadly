...
<form action="<?php echo url_for('i18n_texts/save_translation'); ?>" method="POST" id="wildcard-translation-form">
  ...
  <?php if($sf_user->hasCredential('captain', false)) { ?>
    <?php echo link_to('Delete wildcard', 'i18n_texts/delete_wildcard?w='.$lWildcard->getMsgId().'&c='.$lWildcard->getCatalogueName(), array('class' => 'translate-whole button red small')); ?>
  <?php } ?>
</form>