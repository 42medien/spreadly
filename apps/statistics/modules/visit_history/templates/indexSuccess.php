<div class="content-header-box medium-box">
  <div class="content-box-head">
    <a class="button-green" href="/likebutton/index"><?php echo __('GO!');?></a>
    <h3><?php echo __('Generate Button Codes')?></h3>
  </div>
...
<div class="content-header-box medium-box">
  <div class="content-box-head">
    <a class="button-green" href="/visit_history/analytics"><?php echo __('GO!');?></a>
...
<div class="content-header-box medium-box">
  ...
  <div class="content-box-body">
    ...
    <p><?php echo __("In you have any other questions, please contact");?> <a href="mailto: info@yiid.com">info@yiid.com</a></p>
  </div>
</div>