...
<form action="<?php echo url_for('deals/step_coupon?did='.$pDealId); ?>" name="deal_form" id="deal_form" method="POST">
	...
	<div class="createbtnbox alignleft">
		...
		<ul class="btnformlist">
	  	<li class="clearfix">
	    	<div class="btnwording alignleft">
	      	<strong><?php echo $pForm['coupon_title']->renderLabel(); ?></strong><span><?php echo __('<span id="coupon_title_counter">255</span> characters left'); ?></span>
	      </div>
	      <label class="textfield-wht">
		      <span>
		      	<?php echo $pForm['coupon_title']->render(array('class' => 'wd390')); ?>
					</span>
				</label>
			...
			<li class="clearfix">
				<div class="btnwording alignleft">
					<strong><?php echo $pForm['coupon_text']->renderLabel(); ?></strong> <span><?php echo __('<span id="coupon_text_counter">500</span> characters left'); ?></span>
				</div>
				<div class="alignleft">
						...
						<div class="textaria_middle">
							<div class="textaria_right">
								<label class="textareablock">
									<?php echo $pForm['coupon_text']->render(array('class' => 'wd390')); ?>
								</label>
							</div>
						</div>
	    ...
	    <li class="clearfix coupon-type-select">
	    	<div class="btnwording alignleft">
	      	<strong><?php echo $pForm['coupon_type']->renderLabel(); ?></strong><span><?php echo $pForm['coupon_type']->renderError(); ?></span>
	      </div>
	      <span>
	  	...
	  	<li class="clearfix" <?php echo ($pForm['coupon_type']->getValue() == 'code')? 'style="display:none;"':""; ?> id="coupon-url-row">
	    	<div class="btnwording alignleft">
	      	<strong><?php echo $pForm['coupon_url']->renderLabel(); ?></strong>
	      </div>
	      <label class="textfield-wht">
		      <span>
		      	<?php echo $pForm['coupon_url']->render(array('class' => 'wd390')); ?>
					</span>
				</label>
	  	...
	  	<li class="clearfix" <?php echo ($pForm['coupon_type']->getValue() != 'code')? 'style="display:none;"':""; ?> id="coupon-code-row">
	    	<div class="btnwording alignleft">
	      	<strong><?php echo $pForm['coupon_code']->renderLabel(); ?></strong><span><?php echo __('<span id="coupon_code_counter">255</span> characters left'); ?></span>
	      </div>
	      <label class="textfield-wht">
		      <span>
		      	<?php echo $pForm['coupon_code']->render(array('class' => 'wd390')); ?>
					</span>
				</label>
	  	...
	  	<li class="clearfix" <?php echo ($pForm['coupon_type']->getValue() != 'code')? 'style="display:none;"':""; ?> id="coupon-redeem-row">
	    	<div class="btnwording alignleft">
	      	<strong><?php echo $pForm['coupon_redeem_url']->renderLabel(); ?></strong>
	      </div>
	      <label class="textfield-wht">
		      <span>
		      	<?php echo $pForm['coupon_redeem_url']->render(array('class' => 'wd390')); ?>
					</span>
				</label>
