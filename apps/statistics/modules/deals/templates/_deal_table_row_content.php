...
<?php if($pDeal->getState() == 'paused') { ?>
		  ...
		  <td align="left"><div class="marketbox" title="<?php echo __('Go to analytics for %deal%', array('%deal%' => $pDeal->getSummary())); ?>"><?php echo link_to(truncate_text($pDeal->getSummary(), 20), 'deal_analytics/deal_statistics?deal_id='.$pDeal->getId(), array('class' => 'paused-link')); ?></div></td>
		  <td align="left" valign="middle"><div class="marketbox"><?php echo $pDeal->getDomainProfile()->getUrl(); ?></div></td>
		  <td align="left" valign="middle"><div class="marketbox"><?php echo $pDeal->getStartDate(); ?></div></td>
		  ...
		  <td align="center"><div><?php echo link_to(image_tag('/img/global/24x24/tools.png', array('title' => __('Edit Deal'))), '/deals/get_create_form?deal_id='.$pDeal->getId(), array('class' => 'link-deal-content')); ?></div></td>
		  <td align="center" class="last">
      	<?php echo link_to(image_tag('/img/global/24x24/trash.png', array('title' => __('Delete Deal'))), '/deals/set_state?deal_id='.$pDeal->getId().'&state=trashed', array('class' => 'edit-state')); ?>
