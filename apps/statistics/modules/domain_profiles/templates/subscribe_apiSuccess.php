...
<div id="subscribe-api-box" class="clearfix">
	...
	<div class="clearfix">
	  ...
	  <div>
			...
			<?php if ($pEndpoint) {?>
				<a href="/domain_profiles/unsubscribe_api" title="Unsubscribe Endpoint" id="unsubscribe-api-button" class="graybtnwide"><span><?php echo __('Stop subscription'); ?></span></a>
			<?php } ?>
		</div>
	</div>
