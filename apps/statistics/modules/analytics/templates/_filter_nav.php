    	...
    	<div class="grboxmid-content">
            ...
            <dd>
              ...
              <ul>
                ...
                <li class="last"><?php echo link_to(image_tag('/img/buzz-nav.png', array('width' => '18', 'height'=>'18', 'alt'=>'Google Buzz', 'title'=>'Google Buzz')).__('Google'), '@get_analytics_content', array('query_string' => 'com=google&type=reach_activities&host_id='.$pHostId.'&date-from='.$pDateFrom.'&date-to='.$pDateTo.'&url='.$pUrl.'&dealid='.$pDealId, 'class' => 'analytix-filter-link')); ?></li>
              </ul>
            </dd>
            <dd class="last">
