<ul class="analytics-filter-list clearfix">
	<li>
		...
		<ul class="clearfix">
			...
			<li><?php echo link_to(__('Buzz'), '@get_analytics_content', array('query_string' => 'com=google&type=url_activities&host_id='.$pHostId.'&date-from='.$pDateFrom.'&date-to='.$pDateTo.'&url='.$pUrl, 'class' => 'analytix-filter-link')); ?></li>
		</ul>
	</li>
</ul>
...
<ul class="analytics-filter-list clearfix">
	<li>
		...
		<ul class="clearfix">
			...
			<li><?php echo link_to(__('Buzz'), '@get_analytics_content', array('query_string' => 'com=google&type=domain_activities&host_id='.$pHostId.'&date-from='.$pDateFrom.'&date-to='.$pDateTo, 'class' => 'analytix-filter-link')); ?></li>
		</ul>
	</li>
</ul>
...
<ul class="analytics-filter-list clearfix">
	<li>
		...
		<ul class="clearfix">
			...
			<li><?php echo link_to(__('Buzz'), '@get_analytics_content', array('query_string' => 'com=google&type=reach_activities&host_id='.$pHostId.'&date-from='.$pDateFrom.'&date-to='.$pDateTo, 'class' => 'analytix-filter-link')); ?></li>
		</ul>
	</li>
</ul>
...
<ul class="analytics-filter-list clearfix">
	<li>
		...
		<ul class="clearfix">
			<li><?php echo link_to(__('Age'), '@get_analytics_content', array('query_string' => 'com=all&type=age&host_id='.$pHostId.'&date-from='.$pDateFrom.'&date-to='.$pDateTo, 'class' => 'analytix-filter-link')); ?></li>
			<li><?php echo link_to(__('Gender'), '@get_analytics_content', array('query_string' => 'com=all&type=gender&host_id='.$pHostId.'&date-from='.$pDateFrom.'&date-to='.$pDateTo, 'class' => 'analytix-filter-link')); ?></li>
			<li><?php echo link_to(__('Relationship'), '@get_analytics_content', array('query_string' => 'com=all&type=relationship&host_id='.$pHostId.'&date-from='.$pDateFrom.'&date-to='.$pDateTo, 'class' => 'analytix-filter-link')); ?></li>
		</ul>
	</li>
</ul>