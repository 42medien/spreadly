    ...
    <div class="grboxmid">
    	<div class="grboxmid-content">
	      	<div class="graybox clearfix analyticsbox">
	        	<h2 class="analytics-title"><?php echo __('Age distribution');?></h2>
	          <div class="beshbox">
	          	<?php echo __('The chart shows the distribution of age of the Spread.ly users on the indicated website during the above mentioned period of time.');?>
	          </div>
