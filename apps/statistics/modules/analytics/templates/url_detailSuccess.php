...
<div class="clearfix">
  <label for="host_id" id="filter-period-label" class="alignleft">
    ...
    <?php echo link_to('<span>'.__('Other period').'</span>', 'analytics/select_period?url='.$pUrl.'&domainid='.$pDomainProfile->getId(), array('id' => 'select-period-link', 'class' => 'colorbox alignleft more-button')); ?>
</div>
</form>
<?php end_slot(); ?>
