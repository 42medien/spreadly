...
<?php include_partial('analytics/url_detail_content_by_day', array('pUrls' => $pUrls, 'pUrlSummary' => $pUrlSummary, 'pDomainProfile' => $pDomainProfile, 'date-selector' => 'yesterday', 'showdate' => date("Y-m-d", strtotime("yesterday")))); ?>
</div>