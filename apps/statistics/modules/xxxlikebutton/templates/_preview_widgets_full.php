      ...
      <div class="clearfix">
        ...
        <div id="yiid-widget-1" class="yiid-widget left">
          <?php include_partial('likebutton/widget_full', array('pUrl' => $pUrl, 'pLang' => $pLang, 'pWidth'=>$pWidth, 'pHeight'=>'25', 'pType'=>$pType, 'pFontColor'=>$pFontColor, 'pShort'=>'', 'pSocial'=>'')); ?>
        </div>
      </div>
      ...
      <div class="clearfix">
        ...
        <div id="yiid-widget-3" class="yiid-widget left">
          <?php include_partial('likebutton/widget_full', array('pUrl' => $pUrl, 'pLang' => $pLang, 'pWidth'=>$pWidth, 'pHeight'=>'25', 'pType'=>$pType, 'pFontColor'=>$pFontColor, 'pShort'=>'1', 'pSocial'=>'')); ?>
        </div>
      </div>
