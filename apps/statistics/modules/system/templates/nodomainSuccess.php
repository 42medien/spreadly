<div class="clearfix" id="nodomain-content">
	...
	<p>
		<?php echo __('The confirmation of your domain ownership is required for activating the deal function of the Spreadly button as well as the statistics section. Please confirm it now.'); ?>
	</p>
