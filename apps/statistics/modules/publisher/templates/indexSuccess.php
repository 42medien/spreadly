				...
				<section class="publisher-list">
					<ul class="clearfix">
						...
						<li>
							...
							<span class="link"><a href="<?php echo url_for('domain_profiles/index'); ?>"><?php echo __('Start the domain registration process &raquo;'); ?></a></span>
						</li>
						<li class="last">
							...
							<span class="link"><a href="<?php echo url_for('analytics/index'); ?>"><?php echo __('Watch your detailled site analytics &raquo;'); ?></a></span>
						</li>
					</ul>
				</section>
