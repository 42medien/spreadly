			...
			<section class="container_12">
				<div class="clearfix">
					...
					<div class="alignright grid_4 spread-section">
						...
						<span class="spred-txt"><?php echo __('Warum ist Spreadly anders als addthis oder shareths?'); ?></span><a class="learn-more" href="<?php echo url_for('@customer'); ?>" title="Learn More &raquo;"><?php echo __('Mehr erfahren &raquo;'); ?></a>
					</div>
				</div>
			</section>
		</section>