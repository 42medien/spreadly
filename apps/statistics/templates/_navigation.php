<?php slot('content') ?>
  ...
  <ul id="topnavigation" class="alignleft">
      ...
      <li><a href="<?php echo url_for('@configurator'); ?>" title="Buttons" <?php if($module=='likebutton' && $action=='index') { echo 'class="active"';} ?>><span><?php echo __('Buttons'); ?></span></a></li>
      ...
      <li class="last"><a href="<?php echo url_for('@deals'); ?>" title="Deals"<?php if($module=='deals') { echo 'class="active"';} ?>><span><?php echo __('Deals'); ?></span></a></li>
    <?php endif; ?>
  </ul>
