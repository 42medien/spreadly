...
role :app, %w{ec2-79-125-32-228.eu-west-1.compute.amazonaws.com}
role :web, %w{ec2-79-125-32-228.eu-west-1.compute.amazonaws.com}
...
server 'ec2-79-125-32-228.eu-west-1.compute.amazonaws.com', user: 'root', roles: %w{app web}

set :deploy_to,   "/var/www/button.spread.ly"
...
namespace :deploy do
  ...
  before :finishing, 'symfony:yiid:build_button'
