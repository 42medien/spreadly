...
function writeWholeFile($pDir, $pFileName, $pFileMinName) {
  ...
  $lFiles = FilesystemHelper::retrieveFilesInDir($pDir, array('.svn', 'include', 'vendor', 'configurator', 'shorturl', 'browser', 'engineroom', 'widget'), array($pFileName, $pFileMinName), '.css');
