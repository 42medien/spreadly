 ...
 * @method boolean            getTosAccepted()  Returns the current record's "tos_accepted" value
 ...
 * @method sfGuardUserProfile setTosAccepted()  Sets the current record's "tos_accepted" value
...
abstract class BasesfGuardUserProfile extends sfDoctrineRecord
{
    public function setTableDefinition()
    {
        ...
        $this->hasColumn('email_new', 'string', 80, array(
             'type' => 'string',
             'unique' => true,
             'length' => 80,
             ));
        ...
        $this->hasColumn('lastname', 'string', 70, array(
             'type' => 'string',
             'length' => 70,
             ));
        ...
        $this->hasColumn('tos_accepted', 'boolean', null, array(
             'type' => 'boolean',
             ));
