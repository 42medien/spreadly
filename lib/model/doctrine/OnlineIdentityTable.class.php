...
class OnlineIdentityTable extends Doctrine_Table {
  ...
  const USER_RELATIONSHIP_STATUS_SINGLE = 0;
  const USER_RELATIONSHIP_STATUS_IN_RELATIONSHIP = 1;
  const USER_RELATIONSHIP_STATUS_IN_OPEN_RELATIONSHIP = 2;
  const USER_RELATIONSHIP_STATUS_ENGAGED = 3;
  const USER_RELATIONSHIP_STATUS_MARRIED = 4;
  const USER_RELATIONSHIP_STATUS_COMPLICATED = 5;
  const USER_RELATIONSHIP_STATUS_WIDOWED = 6;
