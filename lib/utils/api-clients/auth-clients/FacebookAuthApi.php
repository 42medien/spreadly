...
class FacebookAuthApiClient extends AuthApi {
  ...
  public function doAuthentication() {
    ...
    header("Location: https://graph.facebook.com/oauth/authorize?client_id=".$lConsumer->key."&display=popup&scope=email,offline_access,publish_stream,user_birthday,user_relationships,user_likes,user_interests&redirect_uri=".$this->getCallbackUri());
    exit;
  }
