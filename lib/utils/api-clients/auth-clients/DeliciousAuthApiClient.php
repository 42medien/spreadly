 ...
 */
class DeliciousAuthApiClient extends AuthApi {

  protected $aCommunity = "delicious";
  ...
  public function getRequestToken() {
    $lRequestToken = OAuthClient::getRequestToken($this->getConsumer(), "https://api.login.yahoo.com/oauth/v2/get_request_token", 'GET', array("oauth_callback" => $this->getCallbackUri()));
  ...
  public function doAuthentication() {
    ...
    $lRequest = OAuthClient::prepareRequest($this->getConsumer(), $lRequestToken, "GET", "https://api.login.yahoo.com/oauth/v2/request_auth");
    // redirect
  ...
  public function getAccessToken($pOAuthToken) {
    $lAccessToken = OAuthClient::getAccessToken($this->getConsumer(), "https://api.login.yahoo.com/oauth/v2/get_token", $pOAuthToken, "GET", array("oauth_verifier" => $pOAuthToken->verifier));
