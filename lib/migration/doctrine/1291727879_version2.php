...
class Version2 extends Doctrine_Migration_Base
{
    public function up()
    {
        $this->createForeignKey('coupon', 'coupon_deal_id_deal_id', array(
             'name' => 'coupon_deal_id_deal_id',
             'local' => 'deal_id',
             'foreign' => 'id',
             'foreignTable' => 'deal',
             'onUpdate' => '',
        ...
        $this->createForeignKey('deal', 'deal_sf_guard_user_id_sf_guard_user_id', array(
             'name' => 'deal_sf_guard_user_id_sf_guard_user_id',
        ...
        $this->createForeignKey('deal', 'deal_domain_profile_id_domain_profile_id', array(
             'name' => 'deal_domain_profile_id_domain_profile_id',
             'local' => 'domain_profile_id',
             'foreign' => 'id',
             'foreignTable' => 'domain_profile',
             'onUpdate' => '',
             'onDelete' => 'CASCADE',
             ));
        $this->createForeignKey('domain_profile', 'domain_profile_sf_guard_user_id_sf_guard_user_id', array(
             'name' => 'domain_profile_sf_guard_user_id_sf_guard_user_id',
             'local' => 'sf_guard_user_id',
             'foreign' => 'id',
             'foreignTable' => 'sf_guard_user',
             'onUpdate' => '',
        ...
        $this->addIndex('coupon', 'coupon_deal_id', array(
             'fields' => 
             array(
              0 => 'deal_id',
             ),
             ));
        $this->addIndex('deal', 'deal_sf_guard_user_id', array(
             'fields' => 
             array(
              0 => 'sf_guard_user_id',
             ),
             ));
        $this->addIndex('deal', 'deal_domain_profile_id', array(
             'fields' => 
             array(
              0 => 'domain_profile_id',
             ),
             ));
        $this->addIndex('domain_profile', 'domain_profile_sf_guard_user_id', array(
             'fields' => 
             array(
              0 => 'sf_guard_user_id',
             ),
    ...
    {
        $this->dropForeignKey('coupon', 'coupon_deal_id_deal_id');
        $this->dropForeignKey('deal', 'deal_sf_guard_user_id_sf_guard_user_id');
        $this->dropForeignKey('deal', 'deal_domain_profile_id_domain_profile_id');
        $this->dropForeignKey('domain_profile', 'domain_profile_sf_guard_user_id_sf_guard_user_id');
        ...
        $this->removeIndex('coupon', 'coupon_deal_id', array(
             'fields' => 
             array(
              0 => 'deal_id',
             ),
             ));
        $this->removeIndex('deal', 'deal_sf_guard_user_id', array(
             'fields' => 
             array(
              0 => 'sf_guard_user_id',
             ),
             ));
        $this->removeIndex('deal', 'deal_domain_profile_id', array(
             'fields' => 
             array(
              0 => 'domain_profile_id',
             ),
             ));
        $this->removeIndex('domain_profile', 'domain_profile_sf_guard_user_id', array(
             'fields' => 
             array(
              0 => 'sf_guard_user_id',
             ),
