...
define('ADMIN_USERNAME','xx'); 	// Admin Username
define('ADMIN_PASSWORD','xyy');  	// Admin Password
define('DATE_FORMAT','Y/m/d H:i:s');
define('GRAPH_SIZE',200);
define('MAX_ITEM_DUMP',50);

#env: andy jo lgeeh milez
#branch: 11 12 13 14
#trunk:  15 16 17 18

$MEMCACHE_SERVERS[] = sfConfig::get('app_memcache_server_ip').':11211'; // add more as an array
