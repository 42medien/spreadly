...
<head>
  ...
  <style type="text/css">
    *{
    ...
    .button {
      ...
      border-radius: 3px;
      background: #fff url('http://s3.amazonaws.com/spread.ly/img/button/s.png') no-repeat 130% -20px;
    ...
    .button:before{
      background: hsla(333,42%,50%,1) url('http://s3.amazonaws.com/spread.ly/img/button/l.png') no-repeat 0px 0px;
  ...
  <link rel="shortcut icon" href="http://s3.amazonaws.com/spread.ly/img/favicon.ico" type="image/x-icon">
</head>
<body>
  <div class="container">
