...
<section class="content-publish">
	<section class="container_12">
		...
		<div class="sf_apply sf_apply_apply">
		  <h2 class="verifytitle"><?php echo __("Apply for an Account", array(), 'sfForkedApply') ?></h2>
		    ...
		    <tfoot>
		      <tr>
		        <td colspan="2" id="signup-button-row">
		            <button type="submit" class="blue-btn alignright"><?php echo __("Create My Account", array(), 'sfForkedApply') ?></button>
		            <?php echo link_to(__("Cancel", array(), 'sfForkedApply'), sfConfig::get('app_sfApplyPlugin_after', '@homepage'), array('class' => 'blue-btn alignright')) ?>
		        </td>
		      </tr>
		    </tfoot>
		  </table>
